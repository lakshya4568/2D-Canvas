...
export function CadViewportOverlays() {
  ...
  return (
    <>
      ...
      <div className="absolute top-0 left-0 right-0 h-6.5 bg-(--ink-app) border-b border-(--rule) flex items-center px-2 select-none z-10">
      ...
      <div className="absolute top-8.5 left-3 pointer-events-none select-none flex items-center gap-1 font-mono text-[10.5px] text-(--fg-muted) bg-(--ink-panel)/80 px-2.5 py-0.5 rounded border border-(--rule)/60 z-10 backdrop-blur-xs">
      ...
      <div className="absolute top-8.5 right-3 pointer-events-auto select-none flex flex-col items-center z-10">
        <div className="w-17 h-17 rounded-full border border-(--rule) bg-(--ink-panel)/90 shadow-md flex items-center justify-center relative backdrop-blur-xs">
          ...
          <div
            ...
            className="w-8.5 h-8.5 bg-(--ink-raised) border border-(--rule-strong) rounded flex items-center justify-center text-[9px] font-bold text-(--fg-primary) font-mono shadow-xs hover:border-(--pen) hover:text-(--pen) cursor-pointer transition-colors"
      ...
      <div className="absolute left-4 bottom-4 pointer-events-none select-none z-10 flex flex-col items-start font-mono">
        <div className="relative w-12.5 h-12.5">
          ...
          <div className="absolute left-2 bottom-[8px] w-[2px] h-[34px] bg-emerald-500 flex flex-col items-center justify-start">
          ...
          <div className="absolute left-2 bottom-2 h-0.5 w-8.5 bg-rose-500 flex items-center justify-end">
