      ...
      if (tL >= 5 && tR >= 5 && tT >= 5 && tB >= 5) {
        ...
        if (stdDev < 3.5) {
          ...
          addFormula({
            ...
            expression: `${outerWidthVar} - 2 * WallThickness`,
            evaluatedValue: Math.round(bInner.width),
            provenance: "inferred",
            confidence,
            reason: `Uniform ${wallT}px clearance discovered across all 4 boundaries (σ = ${stdDev.toFixed(1)}px)`,
            status: "pending",
          ...
          addFormula({
            ...
            expression: `${outerHeightVar} - 2 * WallThickness`,
            evaluatedValue: Math.round(bInner.height),
            provenance: "inferred",
            confidence,
          ...
          addFormula({
            ...
            evaluatedValue: Math.round(bInner.minY),
            provenance: "inferred",
            confidence: 0.95,
          ...
          addFormula({
            ...
            evaluatedValue: Math.round(bInner.minX),
            provenance: "inferred",
            confidence: 0.94,
