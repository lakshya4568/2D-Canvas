...
export const BRIDGE_TERMS: BridgeTerm[] = [
  ...
  { role: "rail_level", label: "Rail level", group: "Levels", kind: "level", definition: "Level of the top of the rail. The bridge's vertical arrangement is set from it downwards through track, ballast and deck.", aliases: ["RAIL LEVEL", "RL OF RAIL", "R L", "TOP OF RAIL", "TOR", "RAIL LVL"], layer: "level", levelLabel: "RAIL LEVEL", fact: "rail_level_m", source: "ircm-402" },
